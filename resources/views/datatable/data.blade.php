            ...
            <div id="myNav" class="overlay">
              <div class="overlay-content">
                ...
                <div class="dropdown-menu overlay-content">
                  ...
                  <a class="dropdown-item" href="/kotadepok">Depok</a>
  ...
  <section class="sale_section layout_padding">
    <div class="container-fluid">
      <ul class="nav justify-content-center">
        <li class="nav-item">
          <a class="nav-link " href="/datatable-jakpus">Jakarta</a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="/datatable-kotadepok">Depok</a>
        </li>
        <li class="nav-item">
            <a class="nav-link " href="/datatable-tangerang">Tangerang</a>
          </li>
        <li class="nav-item">
          <a class="nav-link " href="/datatable-serang">Serang</a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="/datatable-bogor">boogor</a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="/datatable-bekasi">Bekasi</a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="/datatable-ponorogo">Ponorogo</a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="/datatable-sidoarjo">Sidoarjo</a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="/datatable-surabaya">Surabaya</a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="/datatable-pesawaran">Pesawaran</a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="/datatable-cirebon">Cirebon</a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="/datatable-sukabumi">Sukabumi</a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="/datatable-karawang">Karawang</a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="/datatable-bandung">Bandung</a>
        </li>
      </ul>
    </div>
  </section>
