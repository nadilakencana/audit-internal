  ...
  <section class="sale_section layout_padding">
    <div class="container-fluid">
      ...
      <div class="justify-content-right mb-2" style="margin-left: 84%;">
        <a href="/export-pdf-sukabumi" class="btn btn-outline-danger btn-sm">
...
<table cellspacing="0" border="0">
            ...
            <tr>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="center" valign=middle><font face="Times New Roman" color="#000000"><a href="/export-pdf-sukabumi/{{ $row->id }}" class="btn btn-outline-danger btn-sm">
                <i class="fa-sharp fa-solid fa-file-pdf"></i> Export PDF
              </a></font></td>
            @endforeach
            </tr>
