  ...
  <section class="sale_section layout_padding">
    <div class="container-fluid">
      ...
      <div class="justify-content-right mb-2" style="margin-left: 84%;">
        <a href="/export-pdf-sidoarjo" class="btn btn-outline-danger btn-sm">
...
<table cellspacing="0" border="0">
            ...
            <tr>
                <td colspan=12 height="21" align="center" valign=bottom bgcolor="#D5A6BD"><b><font face="Caveat" size=3 color="#000000">Kab Sidoarjo</font></b></td>
                </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="center" valign=middle><font face="Times New Roman" color="#000000"><a href="/export-pdf-sidoarjo/{{ $row->id }}" class="btn btn-outline-danger btn-sm">
                <i class="fa-sharp fa-solid fa-file-pdf"></i> Export PDF
              </a></font></td>
            @endforeach
            </tr>
