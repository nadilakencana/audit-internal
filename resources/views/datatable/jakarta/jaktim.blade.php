  ...
  <section class="sale_section layout_padding">
    <div class="container-fluid">
      ...
      <ul class="nav justify-content-center">
        <li class="nav-item">
          <a class="nav-link " href="/datatable-jakpus">Jakarta Pusat</a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="/datatable-jakut">Jakarta Utara</a>
        </li>
        <li class="nav-item">
            <a class="nav-link " href="/datatable-jaktim">Jakarta Timur</a>
          </li>
        <li class="nav-item">
          <a class="nav-link " href="/datatable-jaksel">Jakarta Selatan</a>
        </li>
      </ul>
      <div class="justify-content-right mb-2" style="margin-left: 84%;">
        <a href="/export-pdf-jaktim" class="btn btn-outline-danger btn-sm">
      ...
      <br/>
        <table cellspacing="0" border="0">
            ...
            <tr>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="center" valign=middle bgcolor="#D9D2E9"><b><font face="Times New Roman" size=3 color="#000000">Export per ID</font></b></td>
            </tr>
             @foreach ($jaktim as $row)
            <tr>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="center" valign=middle><u><font face="Times New Roman" color="#0000FF"><a href="{{ $row->link_foto }}">{{ $row->link_foto }}</a></font></u></td>
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="center" valign=middle><u><font face="Times New Roman" color="#0000FF"><a href="{{ $row->link_maps }}">{{ $row->link_maps }}</a></font></u> </td>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="center" valign=middle><font face="Times New Roman" color="#000000"><a href="/export-pdf-jaktim/{{ $row->id }}" class="btn btn-outline-danger btn-sm">
                <i class="fa-sharp fa-solid fa-file-pdf"></i> Export PDF
              </a></font></td>
            @endforeach
            </tr>
