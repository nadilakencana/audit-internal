    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse navbar-menu-wrapper" id="navbarSupportedContent">
        <ul class="navbar-nav align-items-lg-center align-items-start ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#header-section">Tentang</a>
          </li>
          <li class="nav-item">
        ...
        <div class="container">
          ...
          <div class="row justify-content-between">
            <div class="col-lg-5 d-flex align-items-center justify-content-center about-img">
              <img src="template-frontend/assets/images/HIMTI.png" class="img-fluid" alt="" data-aos="zoom-in">
            </div>
        ...
        <div class="container" class="faq section-bg">
          ...
          <div class="row">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
              <div class="member">
                <img src="template-frontend/assets/images/kaprodi.jpg" class="img-fluid" alt="">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="300">
              <div class="member">
                <img src="template-frontend/assets/images/sekprodi.jpg" class="img-fluid" alt="">
                <div class="member-info">
                  <div class="member-info-content">
                    <h4>Mahpud, M.Kom</h4>
      ...
      <section id="team" class="team">
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
              <div class="member">
                <img src="template-frontend/assets/ninestars/assets/img/team/kahim.jpg" class="img-fluid" alt="">
                <div class="member-info">
                  <div class="member-info-content">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="300">
              <div class="member">
                <img src="template-frontend/assets/ninestars/assets/img/team/wakahim.jpg" class="img-fluid" alt="">
                <div class="member-info">
                  <div class="member-info-content">
                    <h4>Mulyana</h4>
        ...
        <div class="container">
          <div class="row">
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
              <div class="member">
                <img src="template-frontend/assets/ninestars/assets/img/team/sekretaris1.jpg" class="img-fluid" alt="">
                <div class="member-info">
                  <div class="member-info-content">
                    <h4>Anik Sofiatun</h4>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
              <div class="member">
                <img src="template-frontend/assets/ninestars/assets/img/team/sekretaris2.jpg" class="img-fluid" alt="">
                <div class="member-info">
                  <div class="member-info-content">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="300">
              <div class="member">
                <img src="template-frontend/assets/ninestars/assets/img/team/bendahara.jpg" class="img-fluid" alt="">
                <div class="member-info">
                  <div class="member-info-content">
                    <h4>Ahmad Romli</h4>
                    <span>Bendahara</span>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="300">
              <div class="member">
                <img src="template-frontend/assets/ninestars/assets/img/team/sdm.jpg" class="img-fluid" alt="">
                <div class="member-info">
                  <div class="member-info-content">
                    <h4>Okky Pratama</h4>
        ...
        <div class="container">
          <div class="row">
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
              <div class="member">
                <img src="template-frontend/assets/ninestars/assets/img/team/kominfo.jpg" class="img-fluid" alt="">
                <div class="member-info">
                  <div class="member-info-content">
                    <h4>Nanda Aulia</h4>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
              <div class="member">
                <img src="template-frontend/assets/ninestars/assets/img/team/organisasi.jpg" class="img-fluid" alt="">
                <div class="member-info">
                  <div class="member-info-content">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="300">
              <div class="member">
                <img src="template-frontend/assets/ninestars/assets/img/team/litbang.jpg" class="img-fluid" alt="">
                <div class="member-info">
                  <div class="member-info-content">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="300">
              <div class="member">
                <img src="template-frontend/assets/ninestars/assets/img/team/danus.jpg" class="img-fluid" alt="">
                <div class="member-info">
                  <div class="member-info-content">
