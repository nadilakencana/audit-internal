...
<div class="banner">
  <div class="container">
    ...
    <img src="template-frontend/assets/images/HIMTI.png" alt="" class="img-fluid" height="500" width="500">
  </div>
</div>
      ...
      <div class="d-md-flex justify-content-between">
        <div class="grid-margin d-flex justify-content-start">
          <div class="features-width">
            <img src="template-frontend/assets/images/Group12.svg" alt="" class="img-icons">
        ...
        <div class="grid-margin d-flex justify-content-center">
          <div class="features-width">
            <img src="template-frontend/assets/images/clapperboard.png" height="65" width="65" alt="" class="img-icons">
        ...
        <div class="grid-margin d-flex justify-content-end">
          <div class="features-width">
            <img src="template-frontend/assets/images/computer.png" height="65" width="65" alt="" class="img-icons">
    ...
    <section class="digital-marketing-service" id="digital-marketing-section">
      <div class="row align-items-center">
        ...
        <div class="col-12 col-lg-5 p-0 img-digital grid-margin grid-margin-lg-0" data-aos="fade-left">
          <img src="template-frontend/assets/images/himti1.jpg" alt="" height="336" width="306" class="img-fluid">
        </div>
      ...
      <div class="row align-items-center">
        <div class="col-12 col-lg-7 text-center flex-item grid-margin" data-aos="fade-right">
          <img src="template-frontend/assets/images/himti2.jpg" alt="" height="336" width="306" class="img-fluid">
        </div>
        ...
        <div class="row justify-content-center">
          <div class="col">
            <div class="col-md-12 text-center pb-5">
              <img src="template-frontend/assets/images/himti-klinik.png" width="1100" alt="" class="img-fluid">
            ...
            <div class="card-body p-0">
              <div class="bg-primary text-center card-contents">
                <div class="card-image">
                  <img src="template-frontend/assets/images/java.png" class="case-studies-card-img" alt="">
                </div>
                <div class="card-desc-box d-flex align-items-center justify-content-around">
                  <div>
          ...
          <div class="card color-cards">
            <div class="card-body p-0">
              <div class="bg-warning text-center card-contents">
                <div class="card-image">
                  <img src="template-frontend/assets/images/html-coding.png" class="case-studies-card-img" alt="">
                </div>
                <div class="card-desc-box d-flex align-items-center justify-content-around">
                  <div>
          ...
          <div class="card color-cards">
            <div class="card-body p-0">
              <div class="bg-violet text-center card-contents">
                <div class="card-image">
                  <img src="template-frontend/assets/images/computer.png" class="case-studies-card-img" alt="">
                </div>
                <div class="card-desc-box d-flex align-items-center justify-content-around">
                  <div>
          ...
          <div class="card color-cards">
            <div class="card-body p-0">
              <div class="bg-success text-center card-contents">
                <div class="card-image">
                  <img src="template-frontend/assets/images/android-logo.png" class="case-studies-card-img" alt="">
                </div>
                <div class="card-desc-box d-flex align-items-center justify-content-around">
                  <div>
      ...
      <div class="row">
        <div class="owl-carousel owl-theme grid-margin">
          <div class="card customer-cards">
            <div class="card-body">
              <div class="text-center">
                <img src="template-frontend/assets/images/rajif.jpeg" width="89" height="89" alt="" class="img-customer">
          ...
          <div class="card customer-cards">
            <div class="card-body">
              <div class="text-center">
                <img src="template-frontend/assets/images/viky.jpeg" width="89" height="89" alt="" class="img-customer">
          ...
          <div class="card customer-cards">
            <div class="card-body">
              <div class="text-center">
                <img src="template-frontend/assets/images/asad.jpeg" width="89" height="89" alt="" class="img-customer">
          ...
          <div class="card customer-cards">
            <div class="card-body">
              <div class="text-center">
                <img src="template-frontend/assets/images/rangga.jpeg" width="89" height="89" alt="" class="img-customer">
