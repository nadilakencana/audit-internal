                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <div class="row g-3 align-items-center pull-right">
                                    <div class="col-auto">
                                      <form action="/acara" method="GET" enctype="multipart/form-data">
                                    ...
                                    <tbody>
                                      <?php $i = 1; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/tampilacara/{{ $row->id }}" class="btn btn-info">
                                                    <i class="fa-solid fa-pen-to-square"></i>
                                                </a>
                                                <a href="#" class="btn btn-danger deleteacara" data-id="{{ $row->id }}" data-title="{{ $row->title }}">
                                ...
                                <div id="tambah" class="modal fade" role="dialog">
                                    <div class="modal-dialog">
                                      <div class="modal-content">
                                        ...
                                        <form method="post" action="tambahacara" class="formbarang" enctype="multipart/form-data">
                                          @csrf
