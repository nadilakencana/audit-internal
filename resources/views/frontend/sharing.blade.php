      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse navbar-menu-wrapper" id="navbarSupportedContent">
          <ul class="navbar-nav align-items-lg-center align-items-start ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#header-section">Sharing</a>
            </li>
            <li class="nav-item">
        ...
        <div class="row">
          <div class="owl-carousel owl-theme grid-margin">
            <div class="card customer-cards">
              <div class="card-body">
                <div class="text-center">
                  <img src="template-frontend/assets/images/java.png" width="89" height="89" alt="" class="img-customer">
            ...
            <div class="card customer-cards">
              <div class="card-body">
                <div class="text-center"> 
                  <img src="template-frontend/assets/images/html-coding.png" width="95" height="95" alt="" class="img-customer">
            ...
            <div class="card customer-cards">
              <div class="card-body">
                <div class="text-center">
                  <img src="template-frontend/assets/images/computer.png" width="85" height="85" alt="" class="img-customer">
            ...
            <div class="card customer-cards">
              <div class="card-body">
                <div class="text-center">
                  <img src="template-frontend/assets/images/android-logo.png" width="89" height="89" alt="" class="img-customer">
        ...
        <div class="row grid-margin">
          <div class="row align-items-center justify-content-center">
            ...
            <div class="col-5 col-lg-5 flex-item grid-margin" data-aos="fade-left">
              <h3 class="m-0">{{ $row->kategori->kategori }}<br>{{ $row->title }}</h3>
              <div class="col-lg-9 col-xl-8 p-0">
                <p class="py-4 m-0 text-muted">{{ $row->deskripsi }}</p>
                <p class="pb-2 font-weight-medium text-muted"><b>{{ tanggal_indonesia($row->jadwal) }}
