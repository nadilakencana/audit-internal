    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    <form method="post" action="/updateartikel/{{ $data->id }}" enctype="multipart/form-data">
                      @csrf
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        @if ($data->image)
                                        <img src="{{ asset('fotokategori/' . $data->image) }}" class="img-preview img-fluid " width="40px;">
                                        @else
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <a href="/artikel" type="reset" class="btn btn-danger">
