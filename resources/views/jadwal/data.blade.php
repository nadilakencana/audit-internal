                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <div class="row g-3 align-items-center pull-right">
                                    <div class="col-auto">
                                      <form action="/jadwal" method="GET" enctype="multipart/form-data">
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    <thead>
                                        <tr>
                                          ...
                                          <th scope="col">Jadwal Sharing</th>
                                    ...
                                    <tbody>
                                      <?php $i = 1; ?>
                                        ...
                                        <tr>
                                          ...
                                          <td>{{ tanggal_indonesia($row->jadwal) }}</td>
                                          <td>
                                          ...
                                          <td>
                                              <a href="/tampiljadwal/{{ $row->id }}" class="btn btn-info">
                                                <i class="fa-solid fa-pen-to-square"></i>
                                              </a>
                                              <a href="#" class="btn btn-danger deletejadwal" data-id="{{ $row->id }}" data-title="{{ $row->title }}">
                                    ...
                                    <div class="modal-dialog">
                                      <div class="modal-content">
                                        <div class="modal-header">
                                          ...
                                          <h4 class="modal-title text-center text-dark barang">Tambah data Jadwal sharing</h4>
                                        </div>
                                        <form method="post" action="tambahjadwal" class="formbarang" enctype="multipart/form-data">
                                          @csrf
                                            <div class="modal-body">
                                              ...
                                              <div class="form-group">
                                                <label for="" class="control-label">Jadwal Sharing</label>
