    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    <form method="post" action="/updatejadwal/{{ $data->id }}" enctype="multipart/form-data">
                      @csrf
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        <label for="">Jadwal Sharing</label>
                                        <input type="date" name="jadwal" class="form-control" id="jadwal" value="{{ $data->jadwal }}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <a href="/jadwal" type="reset" class="btn btn-danger">
